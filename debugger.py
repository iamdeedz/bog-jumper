...
class Debugger:
    ...
    def update(self, player, lvl):
        ...
        xPosText = self.font.render(f"Player x Position = {round(player.xPosition, 2)}", True, p.Color("green"))
        yPosText = self.font.render(f"Player y Position = {round(player.yPosition, 2)}", True, p.Color("green"))
