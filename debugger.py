...
class Debugger:
    ...
    def update(self, player, lvl):
        ...
        isTopClearText = self.font.render(f"Player isTopClear = {player.isTopClear}", True, p.Color("green"))
        ...
        isUpPressedText = self.font.render(f"Player isUpPressed = {player.isUpPressed}", True, p.Color("green"))
        ...
        texts = [title, xVelocityText, yVelocityText, xPosText, yPosText, lvlText, isGroundedText, isRightClearText,
                 isLeftClearText, isTopClearText, spawnText, isRightPressedText, isLeftPressedText, isUpPressedText]
